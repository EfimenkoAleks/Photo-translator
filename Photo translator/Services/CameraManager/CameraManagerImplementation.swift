//
//  CameraManagerImplementation.swift
//  Photo translator
//
...
class CameraManagerImplementation: ObservableObject {
    ...
    var capturedImagePublished: Published<Data?> { _capturedImage }
    ...
    var shouldShowAlertViewPublished: Published<Bool> { _shouldShowAlertView }
    var shouldShowAlertViewPublisher: Published<Bool>.Publisher { $shouldShowAlertView }
    
    var flashMode: AVCaptureDevice.FlashMode = .off
    private var position: AVCaptureDevice.Position = .back // to store current position
...
extension CameraManagerImplementation: DP_CameraManager {
